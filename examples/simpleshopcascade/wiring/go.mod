module github.com/blueprint-uservices/blueprint/examples/simpleshopcascade/wiring
...
replace github.com/blueprint-uservices/blueprint/examples/simpleshopcascade/workflow => ../workflow
